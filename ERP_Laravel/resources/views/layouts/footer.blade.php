<footer class="p-3 mt-5 bg-warning font-weight-light" style="position:fixed; bottom:0px; left: 0px; width: 100%; height: 5%;">
    <div class="row">
        ...
        <div class="text-center col-md-4">
            ...
            <a href=""><i class="mr-3 fab fa-github fa-lg text-primary"></i></a>

            <a href=""><i class="mr-3 far fa-envelope fa-lg text-success"></i></a>

            <a href=""><i class="fab fa-reddit fa-lg text-danger"></i></a>
